...
export const content = {
  ru: {
    ...
    hero: {
      ...
      priceOld: '', priceNew: '€3200',
      announce: 'Раннее бронирование на сентябрь · 17–20 сентября · €2800 до 13 августа',
    ...
    audience: {
      ...
      checkTitle: 'Этот ретрит для тебя, если ты:',
      checks: [
        'Привыкла всего добиваться через усилие — и устала жить на пределе',
        'Хочешь восстановиться, не сбавляя хода',
        'Играешь в теннис и хочешь совместить любимый спорт с красивым отдыхом и сильным окружением',
    ...
    pricing: {
      ...
      retreats: [
        { label: 'Август', dates: '13–16 августа', priceOld: '', price: '€3200', note: 'Ближайший ретрит · места ограничены', early: false },
        { label: 'Сентябрь', dates: '17–20 сентября', priceOld: '€3200', price: '€2800', note: 'Ранний тариф до 13 августа · потом €3200', early: true },
      ],
      earlyPill: 'Сентябрь · €2800 · ранний тариф до 13 августа',
      pairNote: 'С подругой — €2600 за человека (на любую дату)',
    ...
    apply: {
      eyebrow: 'Заявка',
      title: 'Забронируй своё место',
      micro: 'Мы напишем тебе в Telegram в течение дня.',
      fields: { name: 'Имя', contact: 'Telegram или телефон', level: 'Уровень тенниса', levelOpts: ['Никогда не играла', 'новичок', 'любитель', 'уверенный'], party: 'С кем еду', partyOpts: ['одна', 'с подругой'], comment: 'Комментарий (необязательно)' },
  ...
  es: {
    ...
    hero: {
      ...
      priceOld: '', priceNew: '€3200',
      announce: 'Reserva anticipada para septiembre · 17–20 sept · €2800 hasta el 13 de agosto',
    ...
    audience: {
      ...
      checkTitle: 'Este retiro es para ti si:',
      checks: [
        'Estás acostumbrada a lograrlo todo con esfuerzo — y cansada de vivir al límite',
        'Quieres recuperarte sin bajar el ritmo',
        'Juegas al tenis y quieres combinar tu deporte favorito con un descanso bonito y un entorno fuerte',
    ...
    pricing: {
      ...
      retreats: [
        { label: 'Agosto', dates: '13–16 de agosto', priceOld: '', price: '€3200', note: 'Próximo retiro · plazas limitadas', early: false },
        { label: 'Septiembre', dates: '17–20 de septiembre', priceOld: '€3200', price: '€2800', note: 'Tarifa anticipada hasta el 13 de agosto · luego €3200', early: true },
      ],
      earlyPill: 'Septiembre · €2800 · tarifa anticipada hasta el 13 de agosto',
      pairNote: 'Con una amiga — €2600 por persona (cualquier fecha)',
    ...
    apply: {
      ...
      fields: { name: 'Nombre', contact: 'Telegram o teléfono', level: 'Nivel de tenis', levelOpts: ['Nunca he jugado', 'principiante', 'aficionada', 'avanzada'], party: 'Con quién voy', partyOpts: ['sola', 'con una amiga'], comment: 'Comentario (opcional)' },
  ...
  en: {
    ...
    hero: {
      ...
      priceOld: '', priceNew: '€3200',
      announce: 'Early booking for September · 17–20 Sept · €2800 until 13 August',
    ...
    audience: {
      ...
      checkTitle: 'This retreat is for you if you:',
      checks: [
        "Are used to achieving everything through effort — and tired of living at the limit",
        'Want to recover without slowing down',
        'Play tennis and want to combine your sport with a beautiful escape and strong company',
        'Have always wanted to try tennis but never quite started',
    ...
    pricing: {
      ...
      retreats: [
        { label: 'August', dates: '13–16 August', priceOld: '', price: '€3200', note: 'Next retreat · limited spots', early: false },
        { label: 'September', dates: '17–20 September', priceOld: '€3200', price: '€2800', note: 'Early-bird until 13 August · then €3200', early: true },
      ],
      earlyPill: 'September · €2800 · early-bird until 13 August',
      pairNote: 'With a friend — €2600 per person (either date)',
    ...
    apply: {
      ...
      fields: { name: 'Name', contact: 'Telegram or phone', level: 'Tennis level', levelOpts: ['Never played', 'beginner', 'amateur', 'confident'], party: 'Who I’m coming with', partyOpts: ['solo', 'with a friend'], comment: 'Comment (optional)' },
