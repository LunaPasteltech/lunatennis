...
export const content = {
  ru: {
    ...
    mentors: {
      ...
      people: [
        ...
        },
        {
          ...
          photoSlot: 'IMG: yana — портрет Яны · 4:5',
    ...
    reviews: {
      ...
      people: [
        { name: 'Катя', role: 'Фуд-блогер', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Текст отзыва — Luna пришлёт]', photoSlot: 'IMG: Катя · аватар' },
        { name: 'Наташа', role: 'Фотограф', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Текст отзыва — Luna пришлёт]', photoSlot: 'IMG: Наташа · аватар' },
        { name: 'Алина', role: '[роль уточняется]', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Текст отзыва — Luna пришлёт]', photoSlot: 'IMG: Алина · аватар' },
      ],
    },
  ...
  es: {
    ...
    mentors: {
      ...
      people: [
        ...
        { name: 'Yana', role: 'Yoga y prácticas de respiración', photoSlot: 'IMG: yana — retrato de Yana · 4:5',
    ...
    reviews: {
      ...
      people: [
        { name: 'Katya', role: 'Food blogger', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Reseña — próximamente]', photoSlot: 'IMG: Katya · avatar' },
        { name: 'Natasha', role: 'Fotógrafa', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Reseña — próximamente]', photoSlot: 'IMG: Natasha · avatar' },
        { name: 'Alina', role: '[por confirmar]', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Reseña — próximamente]', photoSlot: 'IMG: Alina · avatar' },
      ],
    },
  ...
  en: {
    ...
    mentors: {
      ...
      people: [
        ...
        { name: 'Yana', role: 'Yoga & breathwork', photoSlot: 'IMG: yana — portrait of Yana · 4:5',
    ...
    reviews: {
      ...
      people: [
        { name: 'Katya', role: 'Food blogger', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Review — coming soon]', photoSlot: 'IMG: Katya · avatar' },
        { name: 'Natasha', role: 'Photographer', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Review — coming soon]', photoSlot: 'IMG: Natasha · avatar' },
        { name: 'Alina', role: '[to confirm]', handle: '@REPLACE', url: 'https://instagram.com/REPLACE', text: '[Review — coming soon]', photoSlot: 'IMG: Alina · avatar' },
      ],
    },
